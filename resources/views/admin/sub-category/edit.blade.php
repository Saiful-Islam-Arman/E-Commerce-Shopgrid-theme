                ...
                <div class="card-body">
                    ...
                    <form action="{{route('subCategory.update', ['id' => $sub_category->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" class="form-control" value="{{$sub_category->name}}" id="horizontal-firstname-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{asset($sub_category->image)}}" width="80" height="80" alt="">
                            </div>
                        </div>
